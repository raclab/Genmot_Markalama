...
$(AS_CPU_PATH)/PowerAx1/PowerAx1.o: \
	...
	$(AS_PROJECT_PATH)/Logical/PowerAx1/PowerAx1.var
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" "$(AS_PROJECT_PATH)/Logical/PowerAx1/PowerAx1.c" -o "$(AS_CPU_PATH)/PowerAx1/PowerAx1.o"  -T SG4  -B R4.02 -G V4.1.2  -s PowerAx1 -t "$(AS_TEMP_PATH)" -I "$(AS_PROJECT_PATH)/Logical/PowerAx1" "$(AS_TEMP_PATH)/Includes/PowerAx1" "$(AS_TEMP_PATH)/Includes" -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -nostartfiles -Wall -include "$(AS_CPU_PATH)/Libraries.h" -x c -P "$(AS_PROJECT_PATH)/" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"
