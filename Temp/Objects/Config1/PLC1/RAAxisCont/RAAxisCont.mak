...
$(AS_CPU_PATH)/RAAxisCont/GX1Ax.o: \
	...
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" "$(AS_PROJECT_PATH)/Logical/RAAxisControl/GX1Ax.c" -o "$(AS_CPU_PATH)/RAAxisCont/GX1Ax.o"  -T SG4  -B R4.02 -G V4.1.2  -s RAAxisControl -t "$(AS_TEMP_PATH)" -I "$(AS_PROJECT_PATH)/Logical/RAAxisControl" "$(AS_TEMP_PATH)/Includes/RAAxisControl" "$(AS_TEMP_PATH)/Includes" -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -nostartfiles -Wall -include "$(AS_CPU_PATH)/Libraries.h" -x c -P "$(AS_PROJECT_PATH)/" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"
