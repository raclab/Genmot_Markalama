...
$(AS_CPU_PATH)/GRYAxisCon/GRYAxisControl.o: \
	...
	$(AS_PROJECT_PATH)/Logical/GRYAxisControl/GRYAxisControl.c \
	$(AS_PROJECT_PATH)/Logical/GRYAxisControl/GRYAxisControl.var \
	$(AS_PROJECT_PATH)/Logical/Global.var \
	$(AS_PROJECT_PATH)/Logical/Libraries/Acp10man/Acp10man.typ \
	$(AS_PROJECT_PATH)/Logical/Global.typ
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" "$(AS_PROJECT_PATH)/Logical/GRYAxisControl/GRYAxisControl.c" -o "$(AS_CPU_PATH)/GRYAxisCon/GRYAxisControl.o"  -T SG4  -B R4.02 -G V4.1.2  -s GRYAxisControl -t "$(AS_TEMP_PATH)" -I "$(AS_PROJECT_PATH)/Logical/GRYAxisControl" "$(AS_TEMP_PATH)/Includes/GRYAxisControl" "$(AS_TEMP_PATH)/Includes" -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -nostartfiles -Wall -include "$(AS_CPU_PATH)/Libraries.h" -x c -P "$(AS_PROJECT_PATH)/" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"
